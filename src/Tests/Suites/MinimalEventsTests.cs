...
namespace Tests
{
    ...
    public class MinimalEventsTests
    {
        ...
        {
            EventSourceAnalyzer.InspectAll(MinimalEventSource.Log);
        }
        ...
        public void TestMinimalEvents()
        {
            ...
            AssertHelper.AssertEventAttributes<MinimalEventSource>("Foo", 1, 0, EventChannel.None, EventLevel.Informational, null, EventKeywords.None, EventTask.None, null);
